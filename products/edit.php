...
<form action="edit.php?id=<?php echo $product['id']; ?>" method="post">
    ...
    <div class="row">
        <div class="form-group col-md-3">
            ...
            <input type="date" class="form-control" name="product['fab_date']" value="<?php echo $product['fab_date']; ?>">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-3">
            <label for="campo3">Data de Validade</label>
            <input type="date" class="form-control" name="product['val_date']" value="<?php echo $product['val_date']; ?>">
        </div>
    </div>
    <div class="row">
        <div class="form-group col-md-3">
